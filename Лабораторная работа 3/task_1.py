...
class PaperBook(Book):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(pages={self.pages!r}, name={self.name!r}, author={self.author!r})"
...
class AudioBook(Book):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(duration={self.duration!r}, name={self.name!r}, author={self.author!r})"
